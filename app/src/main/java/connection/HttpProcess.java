...
public class HttpProcess extends AsyncTask<Void,Void,Void> {
    ...
    public HttpProcess(String _url, OnHttpResponse onResponse) {
        URL = _url;
        METHOD = RequestMethod.GET;
        this.onHttpResponse = onResponse;
    }

    public HttpProcess(String _url, RequestMethod _method,
