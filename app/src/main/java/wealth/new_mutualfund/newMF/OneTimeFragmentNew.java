...
public class OneTimeFragmentNew extends Fragment {
    String SchemeName = "",tag = "",FolioNumber = "";
    ...
    public static OneTimeFragmentNew newInstance(String schemecode,String schemename,String tag) {
        OneTimeFragmentNew itc = new OneTimeFragmentNew();
    ...
    public static OneTimeFragmentNew newInstance() {
        return new OneTimeFragmentNew();
    }

    @BindView(R.id.termcondChkBox)
    CheckBox termcondChkBox;
    //    @BindView(R.id.investbtn)
//    Button investbtn;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View mView = inflater.inflate(R.layout.sip_one_time_invest_screen_new, container, false);
...
//            SchemeNameTV.setText(SchemeName);
            //investbtn.setOnClickListener(_onclick);
            ...
            Double amount = StaticMethods.getStringToDouble(amountstr);
            ...
            search_btn.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    if(schemeNameEditText.getText().toString().trim().length()>=3){
                        ...
                        GlobalClass.showToast(getContext(),"Please enter search text atleast 3 character");
                    }
                }
            });
        ...
        protected String doInBackground(String... strings) {
            try {
                if (msgCode == eMessageCodeWealth.GET_SCHEME_DETAILS.value) {
                    ...
                    jdata.put(eMFJsonTag.OPTION.name, eOperationMF.PURCHASE.name);//Purchase | TopUp | Redeem | SpreadOrder | Switch | SWP | STP | SIP
                    ...
                    try {
                        ...
                        jdata.put(eMFJsonTag.OPTION.name, eOptionMF.PURCHASE.name);
                        jdata.put(eMFJsonTag.SUBCATEGORY.name, "");
            ...
            if (s != null) {
                try {
                    ...
                    if (!jsonData.isNull("error")) {
                        ...
                        if(msgCode == eMessageCodeWealth.GET_SCHEME_DETAILS.value){
                            GlobalClass.showAlertDialog(GlobalClass.getAMCRestrictionMsg());
                            ...
                            if (err.contains("html")) {
                                ...
                                if(err.toLowerCase().contains("success")) {
                                    GlobalClass.showAlertDialog(GlobalClass.getConfirmationMsg(""));
                                }else {
                        ...
                        if(msgCode == eMessageCodeWealth.GET_SCHEME_SEARCH_DATA.value){
                            try {
                                /*JSONObject jsonData = new JSONObject(s);
                                if (!jsonData.isNull("error")) {
                                    String err = jsonData.getString("error");
                        ...
                        else if (msgCode == eMessageCodeWealth.GET_SCHEME_DETAILS.value) {
                            displaData(jsonData);
