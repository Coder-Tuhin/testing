...
public class ModifyOrderReq_SLBM_Pointer extends StructBase {
    ...
    public ModifyOrderReq_SLBM_Pointer() {
        init();
        data = new StructValueSetter(fields);
    }
    public ModifyOrderReq_SLBM_Pointer(byte bytes[]) {
        try {
            init();
    ...
    private void init() {
        ...
        fields = new BaseStructure[]{
                ...
                expityDate,buySell,qty,atMarket,limitPrice,withSL,slTriggered,tiggerPrice,
                traderRequseterID,oldQty,tradeQty,pendingQty,exchOrderID,exchOrderTime,
    ...
    public void setDataForMOdifySLBM(StructBuySell structBuySell, boolean isStopLoss, boolean isIOC, String mktLimitSelection, String orderTypeSelection) {
        ...
        tradeQty.setValue(structBuySell.order.getFinalTradeQty());
        ...
        if(structBuySell.order.aHStatus.getValue() != ' '){
            _ahStatus = structBuySell.order.aHStatus.getValue();
        }
        ahStatus.setValue(_ahStatus);
