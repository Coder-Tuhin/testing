...
public class FingerprintHandlerforpopup extends FingerprintManager.AuthenticationCallback {


    private Context context;
    private FingerprintInterfaceforpopup fingerInterface;
    // Constructor
    public FingerprintHandlerforpopup(Context mContext,FingerprintInterfaceforpopup fingerInterface) {
